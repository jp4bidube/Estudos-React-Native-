...
export default function Routes({scheme}){
  return(
    <Stack.Navigator screenOptions={{headerStyle: {backgroundColor: '#FFF'},headerTintColor:'#ff8f00'}}>
      <Stack.Screen name='Login' scheme={scheme} component={Login} options={{headerShown:false ,title: 'Login',headerTitleAlign:'center'}}/>
